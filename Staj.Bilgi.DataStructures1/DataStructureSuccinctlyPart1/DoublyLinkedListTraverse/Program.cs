...
namespace DoublyLinkedListTraverse
{
    class Program
    {
        class DLinkedList
        {
            private int data;  private DLinkedList next;  private DLinkedList prev;
            public DLinkedList() {data = 0;  next = null;  prev = null;  }
            public DLinkedList(int value) {  data = value;  next = null; prev = null; }
            ...
            public DLinkedList InsertPrev(int value){
                ...
                if (this.prev == null){
                    ...
                    node.prev = temp;  node.next = this;  this.prev = node;  temp.next = node;
                    // temp.prev does not have to be changed
                }
                return node;  }
            public void TraverseFront() { TraverseFront(this); }
            ...
            public void TraverseBack() { TraverseBack(this); }
            ...
            static void Main(string[] args) {
                ...
                node1.TraverseFront();  node5.TraverseBack();
                Console.ReadLine();
            }
        }
    }
